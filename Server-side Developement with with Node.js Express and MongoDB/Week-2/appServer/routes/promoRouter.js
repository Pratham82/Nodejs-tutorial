...
//* Routing requests on promos endpoint
promoRouter
	.route("/")
...
//*  Routing all the requests on the promos/:promoId endpoint

promoRouter
	.route("/:promoId")
	.get((req, res, next) => {
		res.end(
			`Will send the details of the promo: ${req.params.promoId} to you`
		);
	})
